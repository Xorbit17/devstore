...
public class LoginActivity extends Activity {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "dv:Qbmt8400", "jd:Qbmt8400","av:Qbmt8400"
    };

    public static final String PREFS_NAME = "devstoresharedpreferences";
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mSignInButton = (Button) findViewById(R.id.user_sign_in);
    ...
    private boolean isUserValid(String user) {
        return Pattern.matches("^[a-zA-Z0-9]+([_ -]?[a-zA-Z0-9])*$",user);
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                DevStoreDbContract.User currentUser = manager.getUserByName(mUser);
                SharedPreferences settings = getSharedPreferences(PREFS_NAME, MODE_PRIVATE);
                SharedPreferences.Editor editor = settings.edit();
                editor.putInt("userid",currentUser.id);
                editor.commit();
                return true;
